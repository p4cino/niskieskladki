                ...
                <Row style={{height: '100%'}}>
                    <Col xl="12" lg="12" md="12" sm="12" style={{paddingBottom: '2rem'}}>
                        ...
                        <div style={{display: 'flex', width: '100%', paddingBottom: '2rem'}}>
                            <Heading size={"large"} color={"white"} underline={false} type={"h3"}>LUDWIG VON
                                MISES</Heading>
                        </div>
                        <Paragraph color={"white"}>
                            ...
                            uznanie w całej Europie. W kolejnej znakomitej książce Die Gemeinwirtschaft: Untersuchungen
                            über
                            den Sozialismus (Socjalizm, 1922) Mises przewidział upadek socjalizmu. Po Anschlussie
                            Austrii
                    ...
                    <Col xl="12" lg="12" md="12" sm="12" xs="12" style={{paddingBottom: '3rem'}}>
                        <Row>
                            <Col xl="6" lg="6" md="6" sm="6" xs="12">
                                ...
                                <Paragraph color={"white"}>
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae dolorem eius et
                                    facere,
                    ...
                    <Col xl="12" lg="12" md="12" sm="12" xs="12">
                        ...
                        <LinearProgress ref={ref} color="secondary" variant="buffer" value={progress}
                                        valueBuffer={buffer}/>
                    </Col>
                </Row>
            </Container>
